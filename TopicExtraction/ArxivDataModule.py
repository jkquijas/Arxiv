...
class ArxivObj(object):
    ...
    if(platform.system() == 'Windows'):
        text_path = 'C:\\Users\\Jona Q\\Documents\GitHub\\Arxiv\\Data\\Text\\'
        #Path to text file specifying search categories e.g. Smart Cities, Cyber Security, etc. One category per line
        categories_path = 'C:\\Users\\Jona Q\\Documents\GitHub\\Arxiv\\Data\\categories.txt'
    else:
...
class ArxivWriter(ArxivObj):
    if(platform.system() == 'Windows'):
        data_path = 'C:\\Users\\Jona Q\\Documents\GitHub\\Arxiv\\Data\\Keywords\\'
    else:
